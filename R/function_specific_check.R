...
#' @param dataframe1 {\link[base]{data.frame}} expected. Csv or the first output of the function {\link[codama]{logbook_raising_factor_control}}, which must be done before using the display_raising_factor () function.
#' @details
...
#' @param dataframe1 {\link[base]{data.frame}} expected. Csv or the first output of the function {\link[codama]{logbook_little_big_control}}, which must be done before using the display_little_big () function.
#' @details
#' The input dataframe must contain all these columns for the function to work :
#' \itemize{
#' Dataframe 1:
...
#' @param dataframe1 {\link[base]{data.frame}} expected. Csv or the second output of the function {\link[codama]{logbook_temporal_limit_control}}, which must be done before using the plot_temporal_limit_data () function.
...
#' @description Function to create list data/argument
#' @param dataframe1 {\link[base]{data.frame}} expected. Csv or the second output of the function {\link[codama]{logbook_position_control}}, which must be done before using the plot_position_data () function.
...
#' @description Function to create list data/argument
#' @param dataframe1 {\link[base]{data.frame}} expected. Csv or the second output of the function {\link[codama]{logbook_eez_control}}, which must be done before using the plot_eez_data () function.
...
#' @param dataframe1 {\link[base]{data.frame}} expected. Csv or the second output of the function {\link[codama]{logbook_anapo_control}}, which must be done before using the display_anapo () function.
...
#' @param dataframe4 {\link[base]{data.frame}} expected. Csv or the first output of the function {\link[codama]{logbook_anapo_control}}, which must be done before using the display_anapo () function.
#' @details
#' The input dataframe must contain all these columns for the function to work :
#' \itemize{
#' Dataframe 1:
...
#' @description Function to create list data/argument
#' @param dataframe1 {\link[base]{data.frame}} expected. Csv or the second output of the function {\link[codama]{logbook_anapo_control}}, which must be done before using the plot_anapo_data () function.
...
#' @description Function to create list data/argument
#' @param dataframe1 {\link[base]{data.frame}} expected. Csv or the second output of the function {\link[codama]{logbook_anapo_activity_control}}, which must be done before using the plot_anapo_activity_data () function.
