...
app_server <- function(input, output, session) {
  ...
  check_info <- list(list(id = "check_trip_activity",
                          ...
                          type = "warning",
                          function_check = codama::logbook_trip_activity_control,
                     ...
                     list(id = "check_fishing_time",
                          ...
                          type = "error",
                          function_check = codama::logbook_fishing_time_control,
                     ...
                     list(id = "check_sea_time",
                          ...
                          type = "error",
                          function_check = codama::logbook_sea_time_control,
                          argument_function_check = list(dataframe1 = "trip", dataframe2 = "route", output = "report"),
                          table_user_id = "trip",
                          user_type = c("logbook"),
                     ...
                     list(id = "check_landing_consistent",
                          ...
                          type = "warning",
                          function_check = codama::logbook_landing_control,
                     ...
                     list(id = "check_landing_total_weigh",
                          ...
                          type = "error",
                          function_check = codama::logbook_landing_total_weight_control,
                     ...
                     list(id = "check_temporal_limit",
                          ...
                          type = "error",
                          function_check = codama::logbook_temporal_limit_control,
                          argument_function_check = list(dataframe1 = "trip", dataframe2 = "route", output = "report"),
                          table_user_id = "trip",
                          user_type = c("logbook"),
                          column_no_wrap = c(2),
                     ...
                     list(id = "check_harbour",
                          ...
                          type = "error",
                          function_check = codama::logbook_harbour_control,
                     ...
                     list(id = "check_raising_factor",
                          ...
                          type = "info",
                          function_check = codama::logbook_raising_factor_control,
                     ...
                     list(id = "check_fishing_context",
                          ...
                          type = "error",
                          function_check = codama::logbook_fishing_context_control,
                     ...
                     list(id = "check_operation",
                          ...
                          type = "error",
                          function_check = codama::logbook_operation_control,
                     ...
                     list(id = "check_position",
                          ...
                          type = "error",
                          function_check = codama::logbook_position_control,
                     ...
                     list(id = "check_weight",
                          ...
                          type = "error",
                          function_check = codama::logbook_weight_control,
                     ...
                     list(id = "check_temperature",
                          ...
                          type = "error",
                          function_check = codama::logbook_temperature_control,
                          argument_function_check = list(dataframe1 = "activity", output = "report"),
                          table_user_id = "activity",
                          user_type = c("logbook"),
                     ...
                     list(id = "check_weighting_sample",
                          ...
                          type = "error",
                          function_check = codama::logbook_weighting_sample_control,
                     ...
                     list(id = "check_time_route",
                          ...
                          type = "error",
                          function_check = codama::logbook_time_route_control,
                     ...
                     list(id = "check_eez",
                          ...
                          type = "warning",
                          function_check = codama::logbook_eez_control,
                     ...
                     list(id = "check_length_class",
                          ...
                          type = "error",
                          function_check = codama::logbook_length_class_control,
                     ...
                     list(id = "check_measure",
                          ...
                          type = "error",
                          function_check = codama::logbook_measure_control,
                     ...
                     list(id = "check_species",
                          ...
                          type = "error",
                          function_check = codama::logbook_species_control,
                     ...
                     list(id = "check_sample_without_measure",
                          ...
                          type = "error",
                          function_check = codama::logbook_sample_without_measure_control,
                          argument_function_check = list(dataframe1 = "samplespecies", dataframe2 = "samplespeciesmeasure", output = "report"),
                          table_user_id = "samplespecies",
                          user_type = c("logbook"),
                          column_no_wrap = c(2)),
                     list(id = "check_sample_without_species",
                          ...
                          type = "error",
                          function_check = codama::logbook_sample_without_species_control,
                     ...
                     list(id = "check_super_sample_number",
                          ...
                          type = "error",
                          function_check = codama::logbook_super_sample_number_control,
                          argument_function_check = list(dataframe1 = "sample", dataframe2 = "samplespecies", output = "report"),
                          table_user_id = "sample",
                          user_type = c("logbook"),
                     ...
                     list(id = "check_well_number",
                          ...
                          type = "error",
                          function_check = codama::logbook_well_number_control,
                     ...
                     list(id = "check_little_big",
                          ...
                          type = "error",
                          function_check = codama::logbook_little_big_control,
                     ...
                     list(id = "check_weighting",
                          ...
                          type = "error",
                          function_check = codama::logbook_weighting_control,
                     ...
                     list(id = "check_weight_sample",
                          ...
                          type = "error",
                          function_check = codama::logbook_weight_sample_control,
                     ...
                     list(id = "check_activity_sample",
                          ...
                          type = "error",
                          function_check = codama::logbook_activity_sample_control,
                     ...
                     list(id = "check_ldlf",
                          ...
                          type = "error",
                          function_check = codama::logbook_ldlf_control,
                     ...
                     list(id = "check_category_species_forbidden_well",
                          ...
                          type = "warning",
                          function_check = codama::logbook_category_species_forbidden_well_control,
                     ...
                     list(id = "check_distribution",
                          ...
                          type = "error",
                          function_check = codama::logbook_distribution_control,
                     ...
                     list(id = "check_sample_harbour",
                          ...
                          type = "error",
                          function_check = codama::logbook_sample_harbour_control,
                     ...
                     list(id = "check_anapo",
                          ...
                          type = "error",
                          function_check = codama::logbook_anapo_control,
                     ...
                     list(id = "check_anapo_activity",
                          ...
                          type = "error",
                          function_check = codama::logbook_anapo_activity_control,
