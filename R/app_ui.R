        ...
        shinydashboard::tabItems(
          ...
          shinydashboard::tabItem(
            ...
            fluidPage(
              ...
              table_ui(id = "check_operation", title = "Operation", text = "<ul><li>If the vessel activity is \"Fishing (skiff is deployed)\" (code 6), then it needs a success status, otherwise it must not have any</li>
          ...
          shinydashboard::tabItem(
            ...
            fluidPage(
              ...
              table_ui(id = "check_anapo_activity", title = "Anapo activity", text = "<ul><li>Each VMS must have at least one existing activity, for vessel types seiner (large and without bait (5,6)), bait boat (freezer and ice (1,2)) and supply (10)</li></ul>
