...
test_that("Doctest: check_sample_without_measure_inspector", {
  ...
  expect_equal(check_sample_without_measure_inspector(dataframe1, dataframe2, output = "report"), structure(list(samplespecies_id = c(
    "1", "2"), logical = c(TRUE, FALSE)), row.names = c(NA, -2L), class = "data.frame"))
})
