...
test_that("Doctest: plot_eez_windows", {
  ...
  # Source line: 849
  expect_equal(plot_eez_windows(vessel_code = "0", trip_enddate = as.Date("2020/01/10"), activity_date = as.Date("2020/01/09"), activity_number = 1L, X = "E0°6'", Y = "N0°0'",
  fpazone_code = "SYC", fpazone_country_iso3 = "SYC", eez_calculated = "SYC"),
