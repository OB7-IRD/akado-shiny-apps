...
test_that("Doctest: check_raising_factor_inspector", {
  ...
  dataframe2 <- data.frame(catch_id = c("1", "2", "3", "4", "5", "6", "7", "8", "9"), catch_weight = c(10, 2, 15, 8, 5, 25, 4, 5, 9), speciesfate_code = c("6", "6", "1",
    "6", "6", "6", "6", "6", "6"), species_fao_code = c("TUN", "YFT", "TUN", "TUN", "TUN", "SKJ", "SKJ", "LOT", "BET"), vesselactivity_code = c("1", "1", "1", "1", "1",
    "1", "23", "1", "1"), trip_id = c("1", "1", "1", "2", "2", "3", "3", "3", "5"))
