...
test_that("Doctest: check_time_route_inspector", {
  ...
  expect_equal(check_time_route_inspector(dataframe1, dataframe2, dataframe3, output = "report"), structure(list(route_id = c("1", "2", "3", "4", "5", "6", "7", "8"), logical = c(
    TRUE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE), route_seatime = c(6, 2, 0, NA, 8, 26, 15, 8), route_fishingtime = c(5, 0, 2, 4, NA, 7, 14, 9),
