...
test_that("Doctest: plot_anapo_activity_data", {
  ...
  row.names = 1L), date_vms = structure(18274, class = "Date"), crs_vms = 4326, vessel_code = "0", vessel_type = "6"), `2` = list(data_vms = structure(list(vms_position = "POINT (3 0.3)",
    vms_time = "22:32:17"), class = "data.frame", row.names = 2L), date_vms = structure(18274, class = "Date"), crs_vms = 4326, vessel_code = "0", vessel_type = "6")))
})
