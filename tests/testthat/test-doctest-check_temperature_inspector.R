...
test_that("Doctest: check_temperature_inspector", {
  ...
  expect_equal(check_temperature_inspector(dataframe1, output = "report"), structure(list(activity_id = c("1", "2", "3"), logical = c(
    TRUE, FALSE, FALSE), activity_seasurfacetemperature = c(20, 4, 35)), row.names = c(NA, 3L), class = "data.frame"))
})
