...
test_that("Doctest: check_species_inspector", {
  ...
  expect_equal(check_species_inspector(dataframe1, output = "report"), structure(list(samplespecies_id = c("1", "2"), logical = c(
    TRUE, FALSE), species_fao_code = c("YFT", "JOS")), row.names = c(NA, -2L), class = "data.frame"))
})
