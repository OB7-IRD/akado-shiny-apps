...
test_that("Doctest: check_harbour_inspector", {
  ...
  expect_equal(check_harbour_inspector(dataframe1, output = "report"), structure(list(trip_id = c("1", "2", "3", "4", "5"), logical = c(TRUE, TRUE, FALSE, FALSE,
    FALSE), harbour_label_departure = c("Harbour_1", "Harbour_2", "Harbour_3", NA, "Harbour_1"), harbour_label_landing_trip_previous = c(NA, "Harbour_2",
    "Harbour_2", NA, NA)), row.names = c(NA, 5L), class = "data.frame"))
})
