...
test_that("Doctest: check_sample_without_species_inspector", {
  ...
  expect_equal(check_sample_without_species_inspector(dataframe1, dataframe2, output = "report"), structure(list(sample_id = c("1", "2"), logical = c(TRUE, FALSE)), row.names = c(
